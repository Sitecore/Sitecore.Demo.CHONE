...
console.log('I am fetching personalized events true or false : ' + persoanlize );
  ...
  if (events?.length != 0) {
    ...
    featuredEvents[0].sport.results[0].title = "Generated by Azure AI for Mountain Biking"
    ...
    featuredEvents[1].sport.results[0].title = "Generated by Azure AI for Hiking"
